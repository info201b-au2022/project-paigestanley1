...
This chart shows the most popular genres on spotify. The top is pop while the bottom is jazz. It also shows the number of streams for each genre on the y axis.
